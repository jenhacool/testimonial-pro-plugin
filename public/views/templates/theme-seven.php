...
if ( has_post_thumbnail( $post_query->post->ID ) && $client_image ) {
	$outline .= sprintf( '<div class="tpro-client-image tpro-image-style-%1$s tpro-image-position-%3$s">%2$s</div>', $client_image_style, $image, $client_image_position_three );
}

$outline .= $review_title . $review_content;
$outline .= '</div>'; // tpro-testimonial-content-area.
