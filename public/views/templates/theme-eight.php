...
if ( $shortcode_data['testimonial_info_position'] == 'right' || $shortcode_data['testimonial_info_position'] == 'bottom' ) {
...
if ( $shortcode_data['testimonial_info_position'] == 'left' || $shortcode_data['testimonial_info_position'] == 'top' ) {
	$outline .= '<div class="tpro-testimonial-content-area">';
	$outline .= $review_title . $review_content;
	$outline .= '</div>';
}
