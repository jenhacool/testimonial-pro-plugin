...
if ( ! class_exists( 'SPFTESTIMONIAL_Metabox' ) ) {
	class SPFTESTIMONIAL_Metabox extends SPFTESTIMONIAL_Abstract {
		...
		<div class="sp-tpro-banner">
		  <div class="sp-tpro-logo"><img src="<?php echo SP_TPRO_URL . 'admin/assets/images/testimonial-logo.svg'; ?>" alt="Testimonial Pro"></div>
		...
		<div class="tpro_shortcode text-center">
		  ...
		  <div class="tpro_shortcode_content">
			<h2 class="tpro-shortcode-title">
				<?php
				_e( 'Shortcode', 'testimonial-pro' );
				?>
			</h2>
			<p><?php _e( 'Copy and paste this shortcode into your posts or pages:', 'testimonial-pro' ); ?></p>
			<div class="tpro-sc-code selectable" >[sp_testimonial <?php echo 'id="' . $post->ID . '"';?>]</div>
		  </div>
		  </div>
		  <div class="tpro-col-lg-6">
		  <div class="tpro_shortcode_content">
			<h2 class="tpro-shortcode-title">
				<?php
				_e( 'Template Include', 'testimonial-pro' );
				?>
			</h2>
			<p><?php _e( 'Paste the PHP code into your template file:', 'testimonial-pro' ); ?></p>
			<div class="tpro-sc-code selectable">&lt;?php echo do_shortcode('[sp_testimonial id="<?php echo $post->ID; ?>"]');?&gt;</div>
		  </div>
		  </div>
		</div>
		<div class="sp-testimonial-shortcode-divider"></div>
			...
			if ( $has_nav ) {
				...
				foreach ( $this->sections as $section ) {
					...
					echo '<li><a href="#" class="' . $this->unique . '_' . $tab_key . '" data-section="' . $this->unique . '_' . $tab_key . '">' . $tab_icon . $section['title'] . $tab_error . '</a></li>';
			...
			if ( ! empty( $this->args['show_restore'] ) ) {
				...
				echo '<span class="button spftestimonial-button-restore">' . esc_html__( 'Restore', 'testimonial-pro' ) . '</span>';
				echo '<span class="button spftestimonial-button-cancel">' . sprintf( '<small>( %s )</small> %s', esc_html__( 'update post for restore ', 'testimonial-pro' ), esc_html__( 'Cancel', 'testimonial-pro' ) ) . '</span>';
				echo '</label>';
				echo '</div>';
