		...
		public function render() {
			...
			$args = wp_parse_args(
				$this->field, array(
					...
					'large_desktop_placeholder' => esc_html__( 'Large Desktop', 'testimonial-pro' ),
					'desktop_placeholder'       => esc_html__( 'Desktop', 'testimonial-pro' ),
					'laptop_placeholder'        => esc_html__( 'Laptop', 'testimonial-pro' ),
					'tablet_placeholder'        => esc_html__( 'Tablet', 'testimonial-pro' ),
					'mobile_placeholder'        => esc_html__( 'Mobile', 'testimonial-pro' ),
                    'large_desktop'             => true,
                    'desktop'                   => true,
					'laptop'                    => true,
					'tablet'                    => true,
