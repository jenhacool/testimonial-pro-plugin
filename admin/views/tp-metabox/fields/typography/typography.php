      ...
      echo '<div class="spftestimonial--typography'. $chosen_class .'" data-unit="'. $args['unit'] .'" data-exclude="'. $args['exclude'] .'">';
        ...
        echo '<div class="spftestimonial--blocks spftestimonial--blocks-selects">';
          ...
          if( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="spftestimonial--title">'. esc_html__( 'Font Family', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'testimonial-pro' ) );
            echo '</div>';
          }
          ...
          if( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="spftestimonial--title">'. esc_html__( 'Backup Font Family', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( apply_filters( 'spftestimonial_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'testimonial-pro' ) );
            echo '</div>';
          }
          ...
          if( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="spftestimonial--title">'. esc_html__( 'Font Style', 'testimonial-pro') .'</div>';
            echo '<select class="spftestimonial--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'testimonial-pro' ) : '' ) .'</option>';
            ...
            if( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="spftestimonial--title">'. esc_html__( 'Load Extra Styles', 'testimonial-pro' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'testimonial-pro' ) : esc_html__( 'Default', 'testimonial-pro' );
          ...
          if( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="spftestimonial--title">'. esc_html__( 'Subset', 'testimonial-pro' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'testimonial-pro' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if( ! empty( $args['text_align'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Text Align', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'testimonial-pro' ),
              'left'    => esc_html__( 'Left', 'testimonial-pro' ),
              'center'  => esc_html__( 'Center', 'testimonial-pro' ),
              'right'   => esc_html__( 'Right', 'testimonial-pro' ),
              'justify' => esc_html__( 'Justify', 'testimonial-pro' ),
              'initial' => esc_html__( 'Initial', 'testimonial-pro' )
            ), 'text-align', esc_html__( 'Default', 'testimonial-pro' ) );
            echo '</div>';
          }
          ...
          if( ! empty( $args['font_variant'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Font Variant', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'testimonial-pro' ),
              'small-caps'     => esc_html__( 'Small Caps', 'testimonial-pro' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'testimonial-pro' )
            ), 'font-variant', esc_html__( 'Default', 'testimonial-pro' ) );
            echo '</div>';
          }
          ...
          if( ! empty( $args['text_transform'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Text Transform', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( array(
              'none'       => esc_html__( 'None', 'testimonial-pro' ),
              'capitalize' => esc_html__( 'Capitalize', 'testimonial-pro' ),
              'uppercase'  => esc_html__( 'Uppercase', 'testimonial-pro' ),
              'lowercase'  => esc_html__( 'Lowercase', 'testimonial-pro' )
            ), 'text-transform', esc_html__( 'Default', 'testimonial-pro' ) );
            echo '</div>';
          }
          ...
          if( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Text Decoration', 'testimonial-pro' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'testimonial-pro' ),
              'underline'          => esc_html__( 'Solid', 'testimonial-pro' ),
              'underline double'   => esc_html__( 'Double', 'testimonial-pro' ),
              'underline dotted'   => esc_html__( 'Dotted', 'testimonial-pro' ),
              'underline dashed'   => esc_html__( 'Dashed', 'testimonial-pro' ),
              'underline wavy'     => esc_html__( 'Wavy', 'testimonial-pro' ),
              'underline overline' => esc_html__( 'Overline', 'testimonial-pro' ),
              'line-through'       => esc_html__( 'Line-through', 'testimonial-pro' )
            ), 'text-decoration', esc_html__( 'Default', 'testimonial-pro' ) );
            echo '</div>';
          }
        ...
        echo '<div class="spftestimonial--blocks spftestimonial--blocks-inputs">';
          ...
          if( ! empty( $args['font_size'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Font Size', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
            echo '<div class="spftestimonial--block"><input type="number" name="'. $this->field_name( '[font-size]' ) .'" class="spftestimonial--font-size spftestimonial--input spftestimonial-number" value="'. $this->value['font-size'] .'" /></div>';
          ...
          if( ! empty( $args['line_height'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Line Height', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
            echo '<div class="spftestimonial--block"><input type="text" name="'. $this->field_name( '[line-height]' ) .'" class="spftestimonial--line-height spftestimonial--input spftestimonial-number" value="'. $this->value['line-height'] .'" /></div>';
            echo '<div class="spftestimonial--block spftestimonial--unit">'. $args['unit'] .'</div>';
            echo '</div>';
            echo '</div>';
          }
          ...
          if( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Letter Spacing', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
            echo '<div class="spftestimonial--block"><input type="text" name="'. $this->field_name( '[letter-spacing]' ) .'" class="spftestimonial--letter-spacing spftestimonial--input spftestimonial-number" value="'. $this->value['letter-spacing'] .'" /></div>';
            echo '<div class="spftestimonial--block spftestimonial--unit">'. $args['unit'] .'</div>';
            echo '</div>';
            echo '</div>';
          }
          ...
          if( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Word Spacing', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
          ...
          if( ! empty( $args['margin_top'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Margin Top', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
          ...
          if( ! empty( $args['margin_right'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Margin Right', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
          ...
          if( ! empty( $args['margin_bottom'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Margin Bottom', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
          ...
          if( ! empty( $args['margin_left'] ) ) {
            echo '<div class="spftestimonial--block">';
            echo '<div class="spftestimonial--title">'. esc_html__( 'Margin Left', 'testimonial-pro' ) .'</div>';
            echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
        ...
        if( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="spftestimonial--title">'. esc_html__( 'Font Color', 'testimonial-pro' ) .'</div>';
        ...
        if( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="spftestimonial--title">'. esc_html__( 'Custom Style', 'testimonial-pro' ) .'</div>';
      ...
      if( ! wp_style_is( 'spftestimonial-webfont-loader' ) ) {
        ...
        if( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'testimonial-pro' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'testimonial-pro' ),
          'fonts' => apply_filters( 'spftestimonial_field_typography_safewebfonts', array(
            'Arial',
            'Arial Black',
            'Helvetica',
            'Times New Roman',
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'testimonial-pro' ),
          'fonts' => apply_filters( 'spftestimonial_field_typography_googlewebfonts', spftestimonial_get_google_fonts()
        ) );

        $defaultstyles = apply_filters( 'spftestimonial_field_typography_defaultstyles', array( 'normal', 'italic', '700', '700italic' ) );

        $googlestyles = apply_filters( 'spftestimonial_field_typography_googlestyles', array(
          '100'       => 'Thin 100',
        ...
        wp_localize_script( 'spftestimonial', 'spftestimonial_typography_json', array(
          'webfonts'      => $webfonts,
