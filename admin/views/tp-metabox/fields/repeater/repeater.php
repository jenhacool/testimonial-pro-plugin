  ...
  class SPFTESTIMONIAL_Field_repeater extends SPFTESTIMONIAL_Fields {
    ...
    public function render() {
      ...
      if( $this->parent && preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->parent ) ) {
        ...
        echo '<i class="spftestimonial-repeater-remove spftestimonial-confirm fa fa-times" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'testimonial-pro' ) .'"></i>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="spftestimonial-repeater-alert spftestimonial-repeater-max">'. esc_html__( 'You can not add more than', 'testimonial-pro' ) .' '. $args['max'] .'</div>';
        echo '<div class="spftestimonial-repeater-alert spftestimonial-repeater-min">'. esc_html__( 'You can not remove less than', 'testimonial-pro' ) .' '. $args['min'] .'</div>';
