; (function ($, window, document, undefined) {
  ...
  $.fn.spftestimonial_field_background = function () {
    return this.each(function () {
      $(this).find('.spftestimonial--media').spftestimonial_reload_script();
    });
  };
        ...
        if (!SPFTESTIMONIAL.vars.icon_modal_loaded) {
          ...
          window.wp.ajax.post('spftestimonial-get-icons', {
            ...
            $load.on('click', 'a', function (e) {
              ...
              var icon = $(this).data('spftestimonial-icon');

              SPFTESTIMONIAL.vars.$icon_target.find('i').removeAttr('class').addClass(icon);
            ...
            $modal.on('change keyup', '.spftestimonial-icon-search', function () {
              ...
              $icons.each(function () {
                ...
                if ($elem.data('spftestimonial-icon').search(new RegExp(value, 'i')) < 0) {
                  $elem.hide();
                } else {
                  $elem.show();
                }
    ...
    return this.each(function () {
      ...
      $upload_button.on('click', function (e) {
        ...
        wp_media_frame.on('select', function () {
          ...
          $this.find('.spftestimonial--url').val(attributes.url);
          ...
          $this.find('.spftestimonial--thumbnail').val(thumbnail).trigger('change');
      ...
      $remove_button.on('click', function (e) {
        ...
        $this.find('input').val('');
        $this.find('.spftestimonial--thumbnail').trigger('change');
      });
  ...
  $.fn.spftestimonial_reload_script = function (options) {
    ...
    return this.each(function () {
      ...
      if (!$this.data('inited')) {
        ...
        /* $this.children('.spftestimonial-field-dimensions').find('.spftestimonial-number').spftestimonial_number();
        $this.children('.spftestimonial-field-slider').find('.spftestimonial-number').spftestimonial_number();
        ...
        $this.children('.spftestimonial-field-icon_select').find('.spftestimonial-siblings').spftestimonial_siblings();
  ...
  var select_value_layout = $(".tpro-layout-preset .spftestimonial--image-group .spftestimonial--image").find('input:checked').val();
  if (select_value_layout == "slider") {
    $(".spftestimonial-metabox .spftestimonial-nav li a.sp_tpro_shortcode_options_4").show();
  } else {
    $(".spftestimonial-metabox .spftestimonial-nav li a.sp_tpro_shortcode_options_4").hide();
  }

  $(document).on("click", ".tpro-layout-preset .spftestimonial--image-group .spftestimonial--image", function (event) {
    event.stopPropagation();
  ...
  var select_testimonial_type = $('.display_testimonials_from').find('select').val();
  // Manage Group on link on group select.
  if (select_testimonial_type == 'category') {
    $('.display_testimonials_from').find('.spftestimonial-text-desc').show();
  } else {
    $('.display_testimonials_from').find('.spftestimonial-text-desc').hide();
  }
  $('.display_testimonials_from').on('change', function () {
    var select_testimonial_type = $(this).find('select').val();
    if (select_testimonial_type == 'category') {
      $(this).find('.spftestimonial-text-desc').show();
    }else{
      $(this).find('.spftestimonial-text-desc').hide();
    }
  });
  ...
  /* License activation */
  $('.testimonial-pro-license input.btn-license-save-activate').click( function(){
    $('.testimonial-pro-license input.btn-license-activate').click()
  });
